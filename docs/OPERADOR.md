...
4. Inscreva jogadores (mínimo **4**): busca por conta → se não achar, criar incomplete (nome + e-mail + celular; **convite por e-mail automático**). Seeds em opções avançadas (all-or-nothing). Sem walk-in só com nome.
