...
from app.core.auth.invites import email_verify_url, invite_claim_url, password_reset_url
...
from app.core.email.templates import invite_email, password_reset_email, verification_email
